...
const handleUploadResume = async () => {
  ...
  try{
    const result = await axios.post(ServerApi+"/api/interview/resume",formData,{withCredentials:true})
    ...
    <option value="HR">HR Interview</option>
                ...
                {analysisDone && (
                  ...
                  className="bg-gray-50 p-5 space-y-4 rounded-xl border border-gray-200">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Resume Analysis Complete</h3>
