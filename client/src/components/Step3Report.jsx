...
function Step3Report({report}){
  ...
  if(finalScore >= 8){
    performanceText = "Ready for job oppourtunities.";
    ...
    return (
      <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px sm:px-6 lg:px-10 py-8'>
        ...
        <div className="md:mb-10 w-full flex items-start gap-4 flex-wrap">
          ...
          <button 
          onClick={downloadPDF}
          className='bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl shadow-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap'
          >
          Download PDF
          </button>
